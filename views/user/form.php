    ...
    <div class="form" action="index.html">
        ...
        <div class="input-container ic2">
            ...
            <div class="cut"></div>
            <label for="lastname" class="placeholder">Nom de famille</label>
        </div>
        <div class="input-container ic2">
            <input id="lastname" class="input" type="text" placeholder=" " />
            <div class="cut"></div>
        ...
        <div class="input-container ic2">
            <input id="lastname" class="input" type="text" placeholder=" " />
            <div class="cut"></div>
            <label for="lastname" class="placeholder">Confimer votre mot de passe</label>
        </div>
        <div class="input-container ic2">
        ...
        <div class="mb-3 form-check">
            ...
            <label class="form-check-label" for="exampleCheck1">j'accepte les conditions du sites</label>
        </div>
